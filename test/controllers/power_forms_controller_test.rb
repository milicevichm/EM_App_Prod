...
class PowerFormsControllerTest < ActionController::TestCase
  ...
  test "should create power_form" do
    assert_difference('PowerForm.count') do
      post :create, power_form: { appliance: @power_form.appliance, endtime: @power_form.endtime, starttime: @power_form.starttime }
    end
  ...
  test "should update power_form" do
    patch :update, id: @power_form, power_form: { appliance: @power_form.appliance, endtime: @power_form.endtime, starttime: @power_form.starttime }
    assert_redirected_to power_form_path(assigns(:power_form))
  end
